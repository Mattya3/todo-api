...
public class CustomExceptioHander extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<BadRequestError> handleTaskEntityNotFoundException(ConstraintViolationException ex){
        var error = BadRequestErrorCreator.from(ex);
        return ResponseEntity.badRequest().body(error);
    }
}